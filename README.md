...
这是一个基于Vue3和Three.js开发的数字孪生监控平台，支持3D模型查看、数字孪生监控和海事地图功能。

## 功能特点

- **3D模型查看器**：支持查看和操作3D模型
- **数字孪生平台**：工业设备的数字孪生监控系统
- **海事地图**：基于MapTiler的海事地图系统
- **Mapbox海事导航系统**：新增基于Mapbox GL JS的海事导航系统

## 新增功能：Mapbox海事导航系统

最新版本新增了基于Mapbox GL JS的海事导航系统，提供以下功能：
...
1. 在导航菜单中点击"Mapbox航海系统"进入
2. 点击"开始模拟航行"按钮开始导航模拟
3. 使用控制面板上的按钮切换显示功能
4. 点击船舶图标查看详细信息
...
获取Mapbox访问令牌：[https://account.mapbox.com/access-tokens/](https://account.mapbox.com/access-tokens/)
